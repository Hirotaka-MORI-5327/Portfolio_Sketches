...
Nav_High.innerHTML = str_High;
Nav_Low.innerHTML = str_Low;
Nav_Bpm.innerHTML = str_Bpm;
...
function push_NavRw(){
  ...
  window.location.href='input_bpm.html?high=' + str_High + "&low=" + str_Low;
}
...
function func_Send(){
  ...
  if(str_Mon == "　"||str_Mon == ""){
    ...
    window.location.href='input_check.html?high=' + str_High + "&low=" + str_Low + "&bpm=" + str_Bpm + "&temp=" + str_Mon;
  }
}