<?php
    $var_Get_high = htmlspecialchars($_GET['high']);
    $var_Get_low = htmlspecialchars($_GET['low']);
    $var_Get_bpm = htmlspecialchars($_GET['bpm']);
    $var_Get_temp = htmlspecialchars($_GET['temp']);
